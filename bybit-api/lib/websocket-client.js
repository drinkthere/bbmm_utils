...
class WebsocketClient extends events_1.EventEmitter {
    constructor(options, logger) {
        ...
        this.options.restOptions = Object.assign(
    ...
    subscribeV5(wsTopics, category, isPrivateTopic) {
        ...
        return new Promise((resolver, rejector) => {
            topics.forEach((topic) => {
                const wsKey = (0, util_1.getWsKeyForTopic)(
                    this.options.market,
                    topic,
                    isPrivateTopic,
                    category
                ...
                this.upsertPendingTopicsSubscriptions(
                    wsKey,
                    topic,
                    resolver,
                    rejector
    ...
    removeTopicPendingSubscription(wsKey, topic) {
        ...
        if (existingWsKeyPendingSubscriptions) {
            ...
            if (
                !existingWsKeyPendingSubscriptions.pendingTopicsSubscriptions
                    .size
            ) {
                this.pendingTopicsSubscriptions =
                    this.pendingTopicsSubscriptions.filter(
                        (s) => s.wsKey !== wsKey
                    );
            }
        }
    ...
    prepareRESTClient() {
        switch (this.options.market) {
            case "inverse": {
                this.restClient = new inverse_client_1.InverseClient(
            ...
            case "linear": {
                this.restClient = new linear_client_1.LinearClient(
                    this.options.restOptions,
                    this.options.requestOptions
                );
                break;
            ...
            case "spot": {
                this.restClient = new spot_client_1.SpotClient(
                    this.options.restOptions,
                    this.options.requestOptions
                );
                this.connectPublic();
            ...
            case "spotv3": {
                this.restClient = new spot_client_v3_1.SpotClientV3(
                    this.options.restOptions,
                    this.options.requestOptions
                );
                break;
            ...
            case "usdcOption": {
                this.restClient = new usdc_option_client_1.USDCOptionClient(
                    this.options.restOptions,
                    this.options.requestOptions
                );
                break;
            ...
            case "usdcPerp": {
                this.restClient =
                    new usdc_perpetual_client_1.USDCPerpetualClient(
                        this.options.restOptions,
                        this.options.requestOptions
                    );
                break;
            ...
            case "unifiedPerp": {
                this.restClient =
                    new unified_margin_client_1.UnifiedMarginClient(
                        this.options.restOptions,
                        this.options.requestOptions
                    );
                break;
            ...
            case "contractUSDT": {
                this.restClient = new contract_client_1.ContractClient(
                    this.options.restOptions,
                    this.options.requestOptions
                );
                break;
            ...
            case "v5": {
                this.restClient = new rest_client_v5_1.RestClientV5(
                    this.options.restOptions,
                    this.options.requestOptions
                );
                break;
    ...
    getAuthParams(wsKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { signature, expiresAt } = yield this.getWsAuthSignature(
                    wsKey
                );
                const authParams = {
    ...
    getWsAuthSignature(wsKey) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!key || !secret) {
                ...
                throw new Error(
                    "Cannot auth - missing api or secret in config"
                );
            }
            this.logger.debug(
            ...
            const timeOffset = this.options.fetchTimeOffsetBeforeAuth
                ? (yield (_a = this.restClient) === null || _a === void 0
                      ? void 0
                      : _a.fetchTimeOffset()) || 0
                : 0;
    ...
    onWsOpen(event, wsKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (
                wsKey !== util_1.WS_KEY_MAP.spotPublic &&
                wsKey !== util_1.WS_KEY_MAP.spotPrivate
            ) {
    ...
    onWsMessage(event, wsKey) {
        try {
            ...
            if (
                msg["success"] ||
                (msg === null || msg === void 0 ? void 0 : msg.pong) ||
                (0, util_1.isWsPong)(msg)
            ) {
            ...
            if (
                ...
                (msg === null || msg === void 0 ? void 0 : msg.type) ===
                    "error" ||
                // usdc options
                (msg === null || msg === void 0 ? void 0 : msg.success) ===
                    false
            ) {
                return this.emit(
                    "error",
    ...
    subscribePublicSpotOrderbook(symbol, depth, dumpScale, binary) {
        ...
        switch (depth) {
            ...
            case "merge": {
                ...
                if (!dumpScale) {
                    throw new Error(
                        "Dumpscale must be provided for merged orderbooks"
                    );
                }
                break;
            }
    ...
    wsPlaceOrders(reqId, category, topic, orders) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const wsKey = (0, util_1.getWsKeyForTopic)(
                    this.options.market,
    ...
    wsCancelOrders(reqId, category, topic, orders) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const wsKey = (0, util_1.getWsKeyForTopic)(
                    this.options.market,
